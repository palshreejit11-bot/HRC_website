...
const Section: React.FC<SectionProps> = ({ title, children, bgColor = 'bg-white' }) => (
  <section className={`py-16 px-6 ${bgColor}`}>
    <div className="container mx-auto max-w-4xl">
      <h2 className="text-3xl font-bold text-gray-800 mb-6 border-l-4 border-red-700 pl-4">
        {title}
      </h2>
    ...
    <div className="animate-fade-in">
      <header className="bg-gray-100 py-20 text-center">
        <div className="container mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800">Our Work in Detail</h1>
