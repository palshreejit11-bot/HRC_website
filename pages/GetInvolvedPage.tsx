    ...
    <div className="animate-fade-in">
        ...
        <section className="py-20 bg-slate-50">
            <div className="container mx-auto px-6">
                 <h2 className="text-3xl md:text-4xl font-bold text-slate-800 text-center mb-12">Ways to Contribute</h2>
        ...
        <section className="py-20 bg-custom-red text-white">
            <div className="container mx-auto px-6 text-center">
                ...
                <a href="#/contact" className="bg-white text-custom-red font-bold py-3 px-8 rounded-md text-lg hover:bg-slate-100 transition-all duration-300">
                    Contact Us
                </a>
            </div>
        </section>
